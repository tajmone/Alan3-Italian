...
--| prodotto da essa. I messaggi sono definiti tramite attributi stringa sulla
--| classe `blocco_definizioni` (della quale è presente in ogni avventura
--| l'istanza `mia_AT`):
...
-->=============================================================================
--~-----------------------------------------------------------------------------
--| ==== Parametri inadatti con preposizioni articolate
--~-----------------------------------------------------------------------------
--~=============================================================================
--| 
