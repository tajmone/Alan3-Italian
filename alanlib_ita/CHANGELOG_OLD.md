...
Log Range: Alpha v0.0.1–0.8.0.

This is the old changelog of the Italian translation of Alan Standard Library v2.1, covering changes from the initial work (v0.0.1) up to draft translation of all library verbs (v0.8.0).
