= Cloak of Darkness: Versione italiana in Alan 3
Tristano Ajmone; S3RioUs JokER
// Revision Info:
:version-label: Versione
include::cloak_darkness.adoc[tag=rev_info]
:revremark: {AlanSDK}
:lang: it
// TOC Settings:
...
:mappa: image:cloak_mappa.png[Mappa dell'avventura, float="right", title="Mappa dell'avventura"]

include::cloak_darkness.adoc[]
